...
* [Upscale](https://platform.stability.ai/docs/api-reference#tag/Upscale) 
    ...
    * [Creative](https://platform.stability.ai/docs/api-reference#tag/Upscale/paths/~1v2beta~1stable-image~1upscale~1creative/post) (In Backlog)
* [Edit](https://platform.stability.ai/docs/api-reference#tag/Edit)
...
* [Control](https://platform.stability.ai/docs/api-reference#tag/Control)
